...
if (!$token) {
    ...
    $demande= $bdd->query("SELECT * FROM demande WHERE locataireID = $id");
                            ...
                            <?php while($list_demande=$demande->fetch())
                                {
                                    ...
                                    $poste = $bdd->query("SELECT * FROM annonce WHERE  annonceID = '" . $list_demande['annonceID'] . "'");
                                ...
                                <tr>
                                    ...
                                    <td ><?= $list_poste['nom_prenom'] ?></td>
                                    <td ><?= $list_poste['categorie'] ?></td>
                                    <td ><?= $list_poste['chambre']?></td>
                                    <td ><?= $list_poste['salle_bain'] ?></td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            <button class="btn btn-sm btn-primary dropdown-toggle habitha" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                                            Detail
                                            </button>
                                            <ul class="dropdown-menu tahbita" aria-labelledby="dropdownMenuButton" style="min-width: auto;right: 0px;">
                                            <li>
                                                <a class="dropdown-item" href="./property_details.php?id=<?= $list_demande['annonceID'] ?>">Afficher propertier</a>
                                            </li>
                                            ...
                                            <li>
                                                <a class="dropdown-item delete-link" href="./service_user/delete_demande_property_action.php?id=<?= $list_demande['demandeID']?>">Supprimer</a>
                                            </li>
