...
$id = $_SESSION['id'];
$admin = $bdd->query("SELECT * FROM utilisateur where statut='administrateur' and utilisateurID != $id order by  utilisateurID DESC");
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    <meta charset="utf-8">
    <title>Liste administrateurs | Location</title>
            ...
            ?>
                ...
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Liste administrateur</h6>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <li><a class="dropdown-item" href="#">Afficher les informations</a></li>

                                            <li>
                                                <a class="dropdown-item delete-link" href="./service_admin/delete_action.php?id=<?= $list_admin['utilisateurID'] ?>">Supprimer</a>
                                            </li>
