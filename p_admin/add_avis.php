...
<head>
    <meta charset="utf-8">
    <title>Add notice | Location</title>
        ...
        <div class="content">
            ...
            ?>
                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form action="./service_admin/add_avis_action.php" method="post">
                                ...
                                <button type="submit" id="submitButton" class="btn btn-primary">Comment</button>
                            </form>
                        </div>
                    </div>
            <!-- Recent Sales End -->
