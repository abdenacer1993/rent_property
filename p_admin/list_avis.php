...
$avis = $bdd->query("SELECT * FROM avis order by avisID DESC");
// print_r($avis);die();
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    <meta charset="utf-8">
    <title>List notice | Location</title>
                ...
                <div class="bg-light text-center rounded p-4">
                    ...
                    <div class="table-responsive" style="    min-height: 300px;">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                            <?php while($list_avis=$avis->fetch())
                                                    {
                                ...
                                <tr>
                                    ...
                                    <td ><?= $list_avis['nom_prenom']?></td>
                                    <td ><?= $list_avis['email'] ?></td>
                                    <td ><?= $list_avis['text'] ?></td>
                                    
                                    <?php
                                        // Given date
                                        $base_date = new DateTime($list_avis['date']);
                                    ...
                                    <td ><?= $date_di ."ago" ?></td>
                                    <td><?= ($list_avis['lu'] == 0) ? "Unread" : "Read" ?></td>
                                    <td ><?= ($list_avis['annonceID'] == 0) ? "Not found" : $list_avis['annonceID']?></td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="./read_avis.php?id=<?= $list_avis['avisID'] ?>">Read</a>
                                            </li>
                                            

                                            <li>
                                                <a class="dropdown-item delete-link" href="./service_admin/delete_avis_action.php?id=<?= $list_avis['avisID'] ?>">Delete</a>
                                            </li>
